...
{
	public class VenuePin : TKCustomMapPin
	{
	...
	public class SampleViewModel : INotifyPropertyChanged
	{
		...
		private VenuePin _selectedPin;
		private ObservableCollection<VenuePin> _pins;
		...
		Dictionary<VenuePin, TKRoute> _pinRoutes = new Dictionary<VenuePin, TKRoute>();
		...
		public ObservableCollection<VenuePin> Pins
		{
		...
		public Command<VenuePin> DragEndCommand
		{
			get 
			{
				return new Command<VenuePin>(async pin => 
					{
		...
		public SampleViewModel()
		{
			...
			this._pins = new ObservableCollection<VenuePin>(new VenuePin[] 
				{
					new VenuePin
					{
